  ...
  wayland.windowManager.hyprland = {
    ...
    settings = {
      ...
      bind = [
        ...
        "$maiMod, 4, workspace, 4"
        "$maiMod, 5, workspace, 5"
        "$maiMod, 6, workspace, 6"
        "$maiMod, 7, workspace, 7"
        "$maiMod, 8, workspace, 8"
        "$maiMod, 9, workspace, 9"
        "$maiMod, 0, workspace, 10"

        "$maiMod SHIFT, 1, movetoworkspacesilent, 1"
        "$maiMod SHIFT, 2, movetoworkspacesilent, 2"
        "$maiMod SHIFT, 3, movetoworkspacesilent, 3"
        "$maiMod SHIFT, 4, movetoworkspacesilent, 4"
        "$maiMod SHIFT, 5, movetoworkspacesilent, 5"
        "$maiMod SHIFT, 6, movetoworkspacesilent, 6"
        "$maiMod SHIFT, 7, movetoworkspacesilent, 7"
        "$maiMod SHIFT, 8, movetoworkspacesilent, 8"
        "$maiMod SHIFT, 9, movetoworkspacesilent, 9"
        "$maiMod SHIFT, 0, movetoworkspacesilent, 10"
        "$maiMod CTRL, c, movetoworkspace, empty"
